    ...
    <div className="musicPlayer flex flex-col px-5 w-[100%] border-2 border-black py-3 bg-[#232A4E] rounded-xl mt-5">
      ...
      <div className="upper flex items-center  justify-between">
        ...
        <div className="profile flex">
          ...
          />
          <div className="details flex flex-col ml-4 text-start">
      ...
      <div className="lower flex">
        <div className="track flex flex-1 justify-between text-sm text-gray-500 flex-[2] items-center">
          <span>2: 30</span>
          <img
        ...
        <div className="controls flex flex-1 items-center justify-around">
          ...
          {/* Play/Pause Button */}
          <div className="playPauseBtn flex items-center relative">
            {/* cicrle */}
