...
function Search() {
  ...
  return (
    <div className="search relative h-[65rem] px-[5rem] bg-[#081730] pt-[18rem] pb-[10rem] mt-[-15rem] z-[1] flex item-center justify-between rounded-b-[5rem]">
      {/* Left Side */}
      ...
      <div className="right flex items-start flex-col justify-start flex-1 h-[100%] pt-[9rem] z-[2]">
        ...
        {/* Tail Icon */}
        <div className="tail flex justify-start mt-7 items-center w-[100%]">
          <img
         ...
         {/* paragraph */}
         <div className="detail flex items-start flex-col mt-5 text-4xl">
          <span>Search Music by</span>
          <span>
            <b>Name or Direct URL</b>
          </span>
          <span className="text-sm text-left mt-3 text-[#4D586A]">
